...
file = open("C:\\RMB\\QA\\Automation Courses\\CreateUser.json", 'r')  # open in read mode 'r'
...
# requests.post will give a response which will be stored in the response object
